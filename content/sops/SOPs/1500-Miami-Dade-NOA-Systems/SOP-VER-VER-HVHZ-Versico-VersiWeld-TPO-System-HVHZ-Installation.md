# FFR SOP-VER-VER-HVHZ: Versico VersiWeld TPO System HVHZ Installation Procedures
...
**NOA Information:**
- **NOA Number:** 20-1115.02
- **Expiration Date:** undefined
- **Wind Rating:** Design specific
- **Product:** VersiWeld TPO System

**Metadata Tags:** #MIAMI_DADE_NOA #HVHZ_INSTALLATION #VERSICO #VERSIWELD_TPO_SYSTEM #WIND_RESISTANCE #FLORIDA_BUILDING_CODE

---

## BLOCK 1: PURPOSE - Strategic Intent and Business Objectives

To establish comprehensive installation procedures for Versico VersiWeld TPO System roofing systems in High Velocity Hurricane Zone (HVHZ) areas, ensuring full compliance with Miami-Dade County Notice of Acceptance (NOA) requirements and Florida Building Code standards for wind resistance up to Design specific.

**Strategic Objectives:**
- Ensure 100% compliance with NOA 20-1115.02 requirements
- Achieve maximum wind resistance performance of Design specific
...
- Full integration of manufacturer-specific technologies (VersiWeld TPO Technology)
...
This SOP applies to:
- All installations of Versico VersiWeld TPO System in HVHZ areas
...
- Design Wind Speed: Up to 150 mph Vasd / 194 mph Vult
- Ultimate Wind Speed: Per ASCE 7 calculations for HVHZ applications
- Performance Standards: FM 4474 wind uplift and SPRI wind resistance compliance

---

## BLOCK 3: DEFINITIONS - Key Terms and Concepts

**Notice of Acceptance (NOA):** Miami-Dade County approval certifying that VersiWeld TPO System has passed stringent testing and is approved for HVHZ installations per NOA 20-1115.02.
...
**VersiWeld TPO Technology:** Advanced TPO membrane technology with VersiFlex enhanced flexibility and seam strength.

**HVHZ Installation Pattern:** Enhanced 6-nail installation pattern required for wind speeds up to Design specific, exceeding standard 4-nail residential requirements.
...
- Ensure crew certification for Versico VersiWeld TPO System installation
...
### Lead Installer:
- Execute VersiWeld TPO Technology installation procedures
- Implement 6-nail HVHZ pattern per NOA requirements
- Verify fastener specifications: 11-gauge steel roofing nails
- Maintain quality control throughout installation process
- Document any deviations from standard installation procedures

### Installation Crew:
- Follow manufacturer-specific installation guidelines for VersiWeld TPO System
- Implement proper VersiWeld TPO Technology procedures
...
- Verify compliance with NOA 20-1115.02 requirements
- Inspect VersiWeld TPO Technology implementation
- Confirm 6-nail pattern compliance
...
1. Verify NOA 20-1115.02 is current and valid through undefined
2. Confirm Versico VersiWeld TPO System shipment matches NOA specifications
...
1. Verify VersiWeld TPO membrane rolls display Miami-Dade approval labeling
2. Check manufacturer date codes and proper storage temperature requirements (40-100°F)
3. Confirm mechanical fastener specifications: #14 hex washer head screws with 3" diameter plates
4. Set up VersiWeld TPO welding equipment and membrane handling tools
5. Prepare HVHZ-specific membrane attachment systems and welding equipment

### 5.2 VersiWeld TPO Membrane Installation Procedures

**5.2.1 Membrane Edge Preparation and Termination:**
1. Install membrane termination bars at perimeter edges per manufacturer specifications
2. Apply proper membrane relaxation procedures for thermal acclimation
3. Position membrane with minimum 6" lap seams for welded connections
4. Install mechanically attached base sheets where specified
5. Verify proper membrane orientation and seam alignment for welding operations

**5.2.2 Field Membrane Installation with HVHZ Attachment:**
1. Roll out 60 mil TPO membrane allowing minimum 2-hour thermal relaxation
2. Position membrane with 6" minimum overlap for hot-air welded seams
3. Secure membrane using HVHZ-approved mechanical attachment at 12" centers maximum
4. Heat weld all seams using calibrated hot-air welding equipment at 1100°F minimum
5. Test seam integrity using destructive and non-destructive testing methods per SPRI standards
6. Install HVHZ wind-rated edge terminations and flashing integration details

**5.2.3 Membrane Caps and Penetration Details:**
1. Install TPO membrane caps over all ridge and hip areas using welded construction
2. Apply VersiWeld membrane welding procedures to all cap installations
3. Use manufacturer-specified membrane fasteners and termination hardware
4. Maintain proper membrane lap dimensions of 6" minimum at all connections
5. Verify wind uplift ratings for all membrane termination components per FM 4474 standards

### 5.3 Quality Control and Final Verification

**5.3.1 Installation Quality Verification:**
1. Inspect VersiWeld TPO Technology implementation throughout roof
2. Verify 6-nail pattern compliance on random sample
...
1. Complete NOA 20-1115.02 compliance checklist
2. Document VersiWeld TPO Technology implementation
...
- **FORM-NOA-VER-VER-HVHZ-01:** NOA Verification and Material Certification
- **FORM-NOA-VER-VER-HVHZ-02:** VersiWeld TPO Technology Installation Checklist
- **FORM-NOA-VER-VER-HVHZ-03:** HVHZ 6-Nail Pattern Verification Log
- **FORM-NOA-VER-VER-HVHZ-04:** Wind Resistance Testing and Quality Control Report
- **FORM-NOA-VER-VER-HVHZ-05:** Miami-Dade Building Official Inspection Readiness

### Manufacturer-Specific Records
- Complete NOA 20-1115.02 documentation maintained on-site
- Versico installation instructions and technical bulletins
- Material certificates with Miami-Dade approval labeling verification
- VersiWeld TPO Technology implementation photos and documentation
...
- 100% compliance with NOA 20-1115.02 installation requirements
- Zero tolerance for non-NOA approved materials or fasteners
- Complete VersiWeld TPO Technology implementation verification
- Full documentation of 6-nail HVHZ pattern compliance
- Wind resistance performance verification up to Design specific

### Installation Quality Metrics
- Fastener placement accuracy: 100% within manufacturer-specified zones
- VersiWeld TPO Technology compliance: 100% proper implementation
...
- Random sampling inspection of 6-nail pattern (minimum 10% of roof area)
- VersiWeld TPO Technology functionality verification throughout installation
...
- Enhanced fall protection for extended installation times with 6-nail pattern
- Weather monitoring and lightning safety protocols during HVHZ installations
- Proper handling of VersiWeld TPO Technology components and tools
- Heat stress prevention during extended Versico installation procedures
- Tool safety for specialized VersiWeld TPO Technology equipment
...
- Humidity considerations for VersiWeld TPO Technology performance
- Emergency procedure implementation for severe weather events

### Material Handling Safety
- Proper lifting techniques for VersiWeld TPO System bundles and materials
- Slip-resistant footwear requirements for enhanced installation procedures
- Eye protection for nail gun operations with 6-nail pattern
- Respiratory protection during dusty conditions or material cutting
- Ergonomic considerations for extended VersiWeld TPO Technology installation work

---

## BLOCK 9: TRAINING REQUIREMENTS - Competency Development and Certification

### Versico Certification Requirements
- Versico VersiWeld TPO System installation certification (required)
- VersiWeld TPO Technology specialized training completion
...
- VersiWeld TPO Technology safety procedures
...
- NOA 20-1115.02 full compliance with all specifications
...
- Expiration date monitoring and renewal procedures (current through undefined)
...
- VersiWeld TPO Technology implementation success: 100% proper execution
...
- Versico certification maintenance: 100% crew certification compliance
...
- Miami-Dade County NOA 20-1115.02 - Versico VersiWeld TPO System
...
- Versico VersiWeld TPO System Installation Instructions
- VersiWeld TPO Technology Technical Guide and Specifications
- Versico Wind Resistance Performance Data and Testing Results
- Versico Warranty Requirements and Registration Procedures
- Versico Technical Bulletins and Installation Updates
...
- Initial Versico VersiWeld TPO System HVHZ installation SOP
- Integration of NOA 20-1115.02 requirements and specifications
- Implementation of VersiWeld TPO Technology procedures
...
- Q3 2025: VersiWeld TPO Technology technology enhancements
...
- Annual review and certification with Versico technical representatives
...
- Versico VersiWeld TPO System detailed specifications and performance data
- VersiWeld TPO Technology installation diagrams and technical illustrations
- HVHZ 6-nail pattern layouts and fastener specifications
- Wind load calculations and resistance performance charts
- Material storage and handling requirements for VersiWeld TPO System
...
- NOA 20-1115.02 Compliance Verification Checklist
- VersiWeld TPO Technology Installation Quality Control Form
...
- Versico technical support emergency contact information
...
*This SOP ensures proper installation of Versico VersiWeld TPO System roofing systems in High Velocity Hurricane Zone areas, maintaining full compliance with NOA 20-1115.02 requirements and supporting Florida First Roofing LLC's commitment to superior wind-resistant roofing installations.*