# FFR SOP-FIR-RUB-HVHZ: Firestone RubberGard EPDM System HVHZ Installation Procedures
...
**NOA Information:**
- **NOA Number:** 19-0425.01
- **Expiration Date:** undefined
- **Wind Rating:** Per system design
- **Product:** RubberGard EPDM System

**Metadata Tags:** #MIAMI_DADE_NOA #HVHZ_INSTALLATION #FIRESTONE #RUBBERGARD_EPDM_SYSTEM #WIND_RESISTANCE #FLORIDA_BUILDING_CODE

---

## BLOCK 1: PURPOSE - Strategic Intent and Business Objectives

To establish comprehensive installation procedures for Firestone RubberGard EPDM System roofing systems in High Velocity Hurricane Zone (HVHZ) areas, ensuring full compliance with Miami-Dade County Notice of Acceptance (NOA) requirements and Florida Building Code standards for wind resistance up to Per system design.

**Strategic Objectives:**
- Ensure 100% compliance with NOA 19-0425.01 requirements
...
- Full integration of manufacturer-specific technologies (RubberGard EPDM System)
...
This SOP applies to:
- All installations of Firestone RubberGard EPDM System in HVHZ areas
...
**Notice of Acceptance (NOA):** Miami-Dade County approval certifying that RubberGard EPDM System has passed stringent testing and is approved for HVHZ installations per NOA 19-0425.01.
...
**RubberGard EPDM System:** EPDM membrane system with superior weather resistance and proven long-term performance.
...
- Ensure crew certification for Firestone RubberGard EPDM System installation
...
### Lead Installer:
- Execute RubberGard EPDM System installation procedures
...
### Installation Crew:
- Follow manufacturer-specific installation guidelines for RubberGard EPDM System
- Implement proper RubberGard EPDM System procedures
...
- Verify compliance with NOA 19-0425.01 requirements
- Inspect RubberGard EPDM System implementation
...
1. Verify NOA 19-0425.01 is current and valid through undefined
2. Confirm Firestone RubberGard EPDM System shipment matches NOA specifications
...
1. Verify RubberGard EPDM System bundles display Miami-Dade approval labeling
...
2. Apply RubberGard EPDM System to ridge installation
...
1. Inspect RubberGard EPDM System implementation throughout roof
...
1. Complete NOA 19-0425.01 compliance checklist
2. Document RubberGard EPDM System implementation
...
- **FORM-NOA-FIR-RUB-HVHZ-01:** NOA Verification and Material Certification
- **FORM-NOA-FIR-RUB-HVHZ-02:** RubberGard EPDM System Installation Checklist
- **FORM-NOA-FIR-RUB-HVHZ-03:** HVHZ 6-Nail Pattern Verification Log
- **FORM-NOA-FIR-RUB-HVHZ-04:** Wind Resistance Testing and Quality Control Report
- **FORM-NOA-FIR-RUB-HVHZ-05:** Miami-Dade Building Official Inspection Readiness

### Manufacturer-Specific Records
- Complete NOA 19-0425.01 documentation maintained on-site
- Firestone installation instructions and technical bulletins
- Material certificates with Miami-Dade approval labeling verification
- RubberGard EPDM System implementation photos and documentation
...
- 100% compliance with NOA 19-0425.01 installation requirements
- Zero tolerance for non-NOA approved materials or fasteners
- Complete RubberGard EPDM System implementation verification
...
- RubberGard EPDM System compliance: 100% proper implementation
...
- RubberGard EPDM System functionality verification throughout installation
...
- Proper handling of RubberGard EPDM System components and tools
- Heat stress prevention during extended Firestone installation procedures
- Tool safety for specialized RubberGard EPDM System equipment
...
- Humidity considerations for RubberGard EPDM System performance
- Emergency procedure implementation for severe weather events

### Material Handling Safety
- Proper lifting techniques for RubberGard EPDM System bundles and materials
...
- Ergonomic considerations for extended RubberGard EPDM System installation work

---

## BLOCK 9: TRAINING REQUIREMENTS - Competency Development and Certification

### Firestone Certification Requirements
- Firestone RubberGard EPDM System installation certification (required)
- RubberGard EPDM System specialized training completion
...
- RubberGard EPDM System safety procedures
...
- NOA 19-0425.01 full compliance with all specifications
...
- RubberGard EPDM System implementation success: 100% proper execution
...
- Firestone certification maintenance: 100% crew certification compliance
...
- Miami-Dade County NOA 19-0425.01 - Firestone RubberGard EPDM System
...
- Firestone RubberGard EPDM System Installation Instructions
- RubberGard EPDM System Technical Guide and Specifications
- Firestone Wind Resistance Performance Data and Testing Results
- Firestone Warranty Requirements and Registration Procedures
- Firestone Technical Bulletins and Installation Updates
...
- Initial Firestone RubberGard EPDM System HVHZ installation SOP
- Integration of NOA 19-0425.01 requirements and specifications
- Implementation of RubberGard EPDM System procedures
...
- Q3 2025: RubberGard EPDM System technology enhancements
...
- Annual review and certification with Firestone technical representatives
...
- Firestone RubberGard EPDM System detailed specifications and performance data
- RubberGard EPDM System installation diagrams and technical illustrations
- HVHZ 6-nail pattern layouts and fastener specifications
- Wind load calculations and resistance performance charts
- Material storage and handling requirements for RubberGard EPDM System
...
- NOA 19-0425.01 Compliance Verification Checklist
- RubberGard EPDM System Installation Quality Control Form
...
- Firestone technical support emergency contact information
...
*This SOP ensures proper installation of Firestone RubberGard EPDM System roofing systems in High Velocity Hurricane Zone areas, maintaining full compliance with NOA 19-0425.01 requirements and supporting Florida First Roofing LLC's commitment to superior wind-resistant roofing installations.*