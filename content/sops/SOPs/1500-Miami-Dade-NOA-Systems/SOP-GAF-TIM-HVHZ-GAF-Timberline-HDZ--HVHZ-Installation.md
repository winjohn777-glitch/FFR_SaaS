# FFR SOP-GAF-TIM-HVHZ: GAF Timberline HDZ® HVHZ Installation Procedures
...
**NOA Information:**
- **NOA Number:** 21-1209.01
- **Expiration Date:** 2026-12-09
- **Wind Rating:** 150 mph (Vasd) / 194 mph (Vult)
- **Product:** Timberline HDZ®

**Metadata Tags:** #MIAMI_DADE_NOA #HVHZ_INSTALLATION #GAF #TIMBERLINE_HDZ_ #WIND_RESISTANCE #FLORIDA_BUILDING_CODE

---

## BLOCK 1: PURPOSE - Strategic Intent and Business Objectives

To establish comprehensive installation procedures for GAF Timberline HDZ® roofing systems in High Velocity Hurricane Zone (HVHZ) areas, ensuring full compliance with Miami-Dade County Notice of Acceptance (NOA) requirements and Florida Building Code standards for wind resistance up to 150 mph (Vasd) / 194 mph (Vult).

**Strategic Objectives:**
- Ensure 100% compliance with NOA 21-1209.01 requirements
- Achieve maximum wind resistance performance of 150 mph (Vasd) / 194 mph (Vult)
...
- Full integration of manufacturer-specific technologies (LayerLock Technology)
...
This SOP applies to:
- All installations of GAF Timberline HDZ® in HVHZ areas
...
**Notice of Acceptance (NOA):** Miami-Dade County approval certifying that Timberline HDZ® has passed stringent testing and is approved for HVHZ installations per NOA 21-1209.01.
...
**LayerLock Technology:** Mechanical attachment system that creates a strong bond between shingle layers for enhanced wind resistance.

**HVHZ Installation Pattern:** Enhanced 6-nail installation pattern required for wind speeds up to 150 mph (Vasd) / 194 mph (Vult), exceeding standard 4-nail residential requirements.
...
**Solid Wood Deck Requirement:** Minimum Solid wood deck minimum 15/32" OSB or plywood sheathing required for proper fastener engagement and wind uplift resistance.
...
- Ensure crew certification for GAF Timberline HDZ® installation
...
### Lead Installer:
- Execute LayerLock Technology installation procedures
- Implement 6-nail HVHZ pattern per NOA requirements
- Verify fastener specifications: 11-gauge steel roofing nails, minimum 1.25" long
- Maintain quality control throughout installation process
- Document any deviations from standard installation procedures

### Installation Crew:
- Follow manufacturer-specific installation guidelines for Timberline HDZ®
- Implement proper LayerLock Technology procedures
...
- Verify compliance with NOA 21-1209.01 requirements
- Inspect LayerLock Technology implementation
...
1. Verify NOA 21-1209.01 is current and valid through 2026-12-09
2. Confirm GAF Timberline HDZ® shipment matches NOA specifications
...
1. Inspect deck for Solid wood deck minimum 15/32" OSB or plywood
...
1. Verify Timberline HDZ® bundles display Miami-Dade approval labeling
...
4. Set up LayerLock Technology installation tools and guides
5. Prepare HVHZ-specific installation equipment and nail guns

### 5.2 LayerLock Technology Installation Procedures

**5.2.1 Starter Course Installation:**
1. Install manufacturer-approved starter strip at eave edge
2. Apply LayerLock Technology alignment procedures
3. Begin first course with proper overhang (typically 1/4" to 3/8")
4. Implement 6-nail pattern from start
5. Verify initial course alignment with LayerLock Technology guides

**5.2.2 Field Shingle Installation with HVHZ Pattern:**
1. Position shingle with LayerLock Technology activation zones properly aligned
2. Apply 6 nails per manufacturer pattern: 2 nails 1" from each end, 4 nails in field area
...
2. Apply LayerLock Technology to ridge installation
...
1. Inspect LayerLock Technology implementation throughout roof
...
1. Complete NOA 21-1209.01 compliance checklist
2. Document LayerLock Technology implementation
...
- **FORM-NOA-GAF-TIM-HVHZ-01:** NOA Verification and Material Certification
- **FORM-NOA-GAF-TIM-HVHZ-02:** LayerLock Technology Installation Checklist
- **FORM-NOA-GAF-TIM-HVHZ-03:** HVHZ 6-Nail Pattern Verification Log
- **FORM-NOA-GAF-TIM-HVHZ-04:** Wind Resistance Testing and Quality Control Report
- **FORM-NOA-GAF-TIM-HVHZ-05:** Miami-Dade Building Official Inspection Readiness

### Manufacturer-Specific Records
- Complete NOA 21-1209.01 documentation maintained on-site
- GAF installation instructions and technical bulletins
- Material certificates with Miami-Dade approval labeling verification
- LayerLock Technology implementation photos and documentation
...
- 100% compliance with NOA 21-1209.01 installation requirements
- Zero tolerance for non-NOA approved materials or fasteners
- Complete LayerLock Technology implementation verification
- Full documentation of 6-nail HVHZ pattern compliance
- Wind resistance performance verification up to 150 mph (Vasd) / 194 mph (Vult)

### Installation Quality Metrics
- Fastener placement accuracy: 100% within manufacturer-specified zones
- LayerLock Technology compliance: 100% proper implementation
...
- LayerLock Technology functionality verification throughout installation
...
- Proper handling of LayerLock Technology components and tools
- Heat stress prevention during extended GAF installation procedures
- Tool safety for specialized LayerLock Technology equipment
...
- Humidity considerations for LayerLock Technology performance
- Emergency procedure implementation for severe weather events

### Material Handling Safety
- Proper lifting techniques for Timberline HDZ® bundles and materials
...
- Ergonomic considerations for extended LayerLock Technology installation work

---

## BLOCK 9: TRAINING REQUIREMENTS - Competency Development and Certification

### GAF Certification Requirements
- GAF Timberline HDZ® installation certification (required)
- LayerLock Technology specialized training completion
...
- LayerLock Technology safety procedures
...
- NOA 21-1209.01 full compliance with all specifications
...
- Expiration date monitoring and renewal procedures (current through 2026-12-09)
...
- LayerLock Technology implementation success: 100% proper execution
...
- GAF certification maintenance: 100% crew certification compliance
...
- Miami-Dade County NOA 21-1209.01 - GAF Timberline HDZ®
...
- GAF Timberline HDZ® Installation Instructions
- LayerLock Technology Technical Guide and Specifications
- GAF Wind Resistance Performance Data and Testing Results
- GAF Warranty Requirements and Registration Procedures
- GAF Technical Bulletins and Installation Updates
...
- Initial GAF Timberline HDZ® HVHZ installation SOP
- Integration of NOA 21-1209.01 requirements and specifications
- Implementation of LayerLock Technology procedures
...
- Q3 2025: LayerLock Technology technology enhancements
...
- Annual review and certification with GAF technical representatives
...
- GAF Timberline HDZ® detailed specifications and performance data
- LayerLock Technology installation diagrams and technical illustrations
- HVHZ 6-nail pattern layouts and fastener specifications
- Wind load calculations and resistance performance charts
- Material storage and handling requirements for Timberline HDZ®
...
- NOA 21-1209.01 Compliance Verification Checklist
- LayerLock Technology Installation Quality Control Form
...
- GAF technical support emergency contact information
...
*This SOP ensures proper installation of GAF Timberline HDZ® roofing systems in High Velocity Hurricane Zone areas, maintaining full compliance with NOA 21-1209.01 requirements and supporting Florida First Roofing LLC's commitment to superior wind-resistant roofing installations.*