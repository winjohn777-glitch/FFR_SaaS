# FFR SOP-SOP-COL-HVHZ: Soprema Colphene Self-Adhered Modified Bitumen HVHZ Installation Procedures
...
**NOA Information:**
- **NOA Number:** 20-0312.02
- **Expiration Date:** undefined
- **Wind Rating:** Per system design
- **Product:** Colphene Self-Adhered Modified Bitumen

**Metadata Tags:** #MIAMI_DADE_NOA #HVHZ_INSTALLATION #SOPREMA #COLPHENE_SELF_ADHERED_MODIFIED_BITUMEN #WIND_RESISTANCE #FLORIDA_BUILDING_CODE

---

## BLOCK 1: PURPOSE - Strategic Intent and Business Objectives

To establish comprehensive installation procedures for Soprema Colphene Self-Adhered Modified Bitumen roofing systems in High Velocity Hurricane Zone (HVHZ) areas, ensuring full compliance with Miami-Dade County Notice of Acceptance (NOA) requirements and Florida Building Code standards for wind resistance up to Per system design.

**Strategic Objectives:**
- Ensure 100% compliance with NOA 20-0312.02 requirements
- Achieve maximum wind resistance performance of Per system design
...
- Full integration of manufacturer-specific technologies (SBS Modified Bitumen Technology)
...
This SOP applies to:
- All installations of Soprema Colphene Self-Adhered Modified Bitumen in HVHZ areas
...
- Design Wind Speed: Up to Per system design
...
**Notice of Acceptance (NOA):** Miami-Dade County approval certifying that Colphene Self-Adhered Modified Bitumen has passed stringent testing and is approved for HVHZ installations per NOA 20-0312.02.
...
**SBS Modified Bitumen Technology:** SBS modified bitumen technology providing superior flexibility, adhesion, and weather resistance.

**HVHZ Installation Pattern:** Enhanced 6-nail installation pattern required for wind speeds up to Per system design, exceeding standard 4-nail residential requirements.
...
- Ensure crew certification for Soprema Colphene Self-Adhered Modified Bitumen installation
...
### Lead Installer:
- Execute SBS Modified Bitumen Technology installation procedures
...
### Installation Crew:
- Follow manufacturer-specific installation guidelines for Colphene Self-Adhered Modified Bitumen
- Implement proper SBS Modified Bitumen Technology procedures
...
- Verify compliance with NOA 20-0312.02 requirements
- Inspect SBS Modified Bitumen Technology implementation
...
1. Verify NOA 20-0312.02 is current and valid through undefined
2. Confirm Soprema Colphene Self-Adhered Modified Bitumen shipment matches NOA specifications
...
1. Verify Colphene Self-Adhered Modified Bitumen bundles display Miami-Dade approval labeling
...
4. Set up SBS Modified Bitumen Technology installation tools and guides
5. Prepare HVHZ-specific installation equipment and nail guns

### 5.2 SBS Modified Bitumen Technology Installation Procedures

**5.2.1 Starter Course Installation:**
1. Install manufacturer-approved starter strip at eave edge
2. Apply SBS Modified Bitumen Technology alignment procedures
3. Begin first course with proper overhang (typically 1/4" to 3/8")
4. Implement 6-nail pattern from start
5. Verify initial course alignment with SBS Modified Bitumen Technology guides

**5.2.2 Field Shingle Installation with HVHZ Pattern:**
1. Apply base sheet with proper substrate preparation and priming
...
2. Apply SBS Modified Bitumen Technology to ridge installation
...
1. Inspect SBS Modified Bitumen Technology implementation throughout roof
...
1. Complete NOA 20-0312.02 compliance checklist
2. Document SBS Modified Bitumen Technology implementation
...
- **FORM-NOA-SOP-COL-HVHZ-01:** NOA Verification and Material Certification
- **FORM-NOA-SOP-COL-HVHZ-02:** SBS Modified Bitumen Technology Installation Checklist
- **FORM-NOA-SOP-COL-HVHZ-03:** HVHZ 6-Nail Pattern Verification Log
- **FORM-NOA-SOP-COL-HVHZ-04:** Wind Resistance Testing and Quality Control Report
- **FORM-NOA-SOP-COL-HVHZ-05:** Miami-Dade Building Official Inspection Readiness

### Manufacturer-Specific Records
- Complete NOA 20-0312.02 documentation maintained on-site
- Soprema installation instructions and technical bulletins
- Material certificates with Miami-Dade approval labeling verification
- SBS Modified Bitumen Technology implementation photos and documentation
...
- 100% compliance with NOA 20-0312.02 installation requirements
- Zero tolerance for non-NOA approved materials or fasteners
- Complete SBS Modified Bitumen Technology implementation verification
- Full documentation of 6-nail HVHZ pattern compliance
- Wind resistance performance verification up to Per system design

### Installation Quality Metrics
- Fastener placement accuracy: 100% within manufacturer-specified zones
- SBS Modified Bitumen Technology compliance: 100% proper implementation
...
- SBS Modified Bitumen Technology functionality verification throughout installation
...
- Proper handling of SBS Modified Bitumen Technology components and tools
- Heat stress prevention during extended Soprema installation procedures
- Tool safety for specialized SBS Modified Bitumen Technology equipment
...
- Humidity considerations for SBS Modified Bitumen Technology performance
- Emergency procedure implementation for severe weather events

### Material Handling Safety
- Proper lifting techniques for Colphene Self-Adhered Modified Bitumen bundles and materials
...
- Ergonomic considerations for extended SBS Modified Bitumen Technology installation work

---

## BLOCK 9: TRAINING REQUIREMENTS - Competency Development and Certification

### Soprema Certification Requirements
- Soprema Colphene Self-Adhered Modified Bitumen installation certification (required)
- SBS Modified Bitumen Technology specialized training completion
...
- SBS Modified Bitumen Technology safety procedures
...
- NOA 20-0312.02 full compliance with all specifications
...
- SBS Modified Bitumen Technology implementation success: 100% proper execution
...
- Soprema certification maintenance: 100% crew certification compliance
...
- Miami-Dade County NOA 20-0312.02 - Soprema Colphene Self-Adhered Modified Bitumen
...
- Soprema Colphene Self-Adhered Modified Bitumen Installation Instructions
- SBS Modified Bitumen Technology Technical Guide and Specifications
- Soprema Wind Resistance Performance Data and Testing Results
- Soprema Warranty Requirements and Registration Procedures
- Soprema Technical Bulletins and Installation Updates
...
- Initial Soprema Colphene Self-Adhered Modified Bitumen HVHZ installation SOP
- Integration of NOA 20-0312.02 requirements and specifications
- Implementation of SBS Modified Bitumen Technology procedures
...
- Q3 2025: SBS Modified Bitumen Technology technology enhancements
...
- Annual review and certification with Soprema technical representatives
...
- Soprema Colphene Self-Adhered Modified Bitumen detailed specifications and performance data
- SBS Modified Bitumen Technology installation diagrams and technical illustrations
- HVHZ 6-nail pattern layouts and fastener specifications
- Wind load calculations and resistance performance charts
- Material storage and handling requirements for Colphene Self-Adhered Modified Bitumen
...
- NOA 20-0312.02 Compliance Verification Checklist
- SBS Modified Bitumen Technology Installation Quality Control Form
...
- Soprema technical support emergency contact information
...
*This SOP ensures proper installation of Soprema Colphene Self-Adhered Modified Bitumen roofing systems in High Velocity Hurricane Zone areas, maintaining full compliance with NOA 20-0312.02 requirements and supporting Florida First Roofing LLC's commitment to superior wind-resistant roofing installations.*