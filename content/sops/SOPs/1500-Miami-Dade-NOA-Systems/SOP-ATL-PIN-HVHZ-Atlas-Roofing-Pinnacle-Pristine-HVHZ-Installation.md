# FFR SOP-ATL-PIN-HVHZ: Atlas Roofing Pinnacle® Pristine HVHZ Installation Procedures
...
**Metadata Tags:** #MIAMI_DADE_NOA #HVHZ_INSTALLATION #ATLAS_ROOFING #PINNACLE__PRISTINE #WIND_RESISTANCE #FLORIDA_BUILDING_CODE

---

## BLOCK 1: PURPOSE - Strategic Intent and Business Objectives

To establish comprehensive installation procedures for Atlas Roofing Pinnacle® Pristine roofing systems in High Velocity Hurricane Zone (HVHZ) areas, ensuring full compliance with Miami-Dade County Notice of Acceptance (NOA) requirements and Florida Building Code standards for wind resistance up to 130 mph.

**Strategic Objectives:**
- Ensure 100% compliance with NOA Various requirements
- Achieve maximum wind resistance performance of 130 mph
...
- Full integration of manufacturer-specific technologies (Scotchgard Technology)
...
This SOP applies to:
- All installations of Atlas Roofing Pinnacle® Pristine in HVHZ areas
...
- Design Wind Speed: Up to 130 mph
...
**Notice of Acceptance (NOA):** Miami-Dade County approval certifying that Pinnacle® Pristine has passed stringent testing and is approved for HVHZ installations per NOA Various.
...
**Scotchgard Technology:** Advanced polymer coating technology that provides enhanced weather resistance and durability.

**HVHZ Installation Pattern:** Enhanced 6-nail installation pattern required for wind speeds up to 130 mph, exceeding standard 4-nail residential requirements.
...
- Ensure crew certification for Atlas Roofing Pinnacle® Pristine installation
...
### Lead Installer:
- Execute Scotchgard Technology installation procedures
...
### Installation Crew:
- Follow manufacturer-specific installation guidelines for Pinnacle® Pristine
- Implement proper Scotchgard Technology procedures
...
- Verify compliance with NOA Various requirements
- Inspect Scotchgard Technology implementation
...
1. Verify NOA Various is current and valid through undefined
2. Confirm Atlas Roofing Pinnacle® Pristine shipment matches NOA specifications
...
1. Verify Pinnacle® Pristine bundles display Miami-Dade approval labeling
...
4. Set up Scotchgard Technology installation tools and guides
5. Prepare HVHZ-specific installation equipment and nail guns

### 5.2 Scotchgard Technology Installation Procedures

**5.2.1 Starter Course Installation:**
1. Install manufacturer-approved starter strip at eave edge
2. Apply Scotchgard Technology alignment procedures
3. Begin first course with proper overhang (typically 1/4" to 3/8")
4. Implement 6-nail pattern from start
5. Verify initial course alignment with Scotchgard Technology guides

**5.2.2 Field Shingle Installation with HVHZ Pattern:**
1. Position shingles according to manufacturer installation guides
2. Install 6 nails per HVHZ requirements
...
2. Apply Scotchgard Technology to ridge installation
...
1. Inspect Scotchgard Technology implementation throughout roof
...
1. Complete NOA Various compliance checklist
2. Document Scotchgard Technology implementation
...
- **FORM-NOA-ATL-PIN-HVHZ-01:** NOA Verification and Material Certification
- **FORM-NOA-ATL-PIN-HVHZ-02:** Scotchgard Technology Installation Checklist
- **FORM-NOA-ATL-PIN-HVHZ-03:** HVHZ 6-Nail Pattern Verification Log
- **FORM-NOA-ATL-PIN-HVHZ-04:** Wind Resistance Testing and Quality Control Report
- **FORM-NOA-ATL-PIN-HVHZ-05:** Miami-Dade Building Official Inspection Readiness

### Manufacturer-Specific Records
- Complete NOA Various documentation maintained on-site
- Atlas Roofing installation instructions and technical bulletins
- Material certificates with Miami-Dade approval labeling verification
- Scotchgard Technology implementation photos and documentation
...
- 100% compliance with NOA Various installation requirements
- Zero tolerance for non-NOA approved materials or fasteners
- Complete Scotchgard Technology implementation verification
- Full documentation of 6-nail HVHZ pattern compliance
- Wind resistance performance verification up to 130 mph

### Installation Quality Metrics
- Fastener placement accuracy: 100% within manufacturer-specified zones
- Scotchgard Technology compliance: 100% proper implementation
...
- Scotchgard Technology functionality verification throughout installation
...
- Proper handling of Scotchgard Technology components and tools
- Heat stress prevention during extended Atlas Roofing installation procedures
- Tool safety for specialized Scotchgard Technology equipment
...
- Humidity considerations for Scotchgard Technology performance
- Emergency procedure implementation for severe weather events

### Material Handling Safety
- Proper lifting techniques for Pinnacle® Pristine bundles and materials
...
- Ergonomic considerations for extended Scotchgard Technology installation work

---

## BLOCK 9: TRAINING REQUIREMENTS - Competency Development and Certification

### Atlas Roofing Certification Requirements
- Atlas Roofing Pinnacle® Pristine installation certification (required)
- Scotchgard Technology specialized training completion
...
- Scotchgard Technology safety procedures
...
- NOA Various full compliance with all specifications
...
- Scotchgard Technology implementation success: 100% proper execution
...
- Atlas Roofing certification maintenance: 100% crew certification compliance
...
- Miami-Dade County NOA Various - Atlas Roofing Pinnacle® Pristine
...
- Atlas Roofing Pinnacle® Pristine Installation Instructions
- Scotchgard Technology Technical Guide and Specifications
- Atlas Roofing Wind Resistance Performance Data and Testing Results
- Atlas Roofing Warranty Requirements and Registration Procedures
- Atlas Roofing Technical Bulletins and Installation Updates
...
- Initial Atlas Roofing Pinnacle® Pristine HVHZ installation SOP
- Integration of NOA Various requirements and specifications
- Implementation of Scotchgard Technology procedures
...
- Q3 2025: Scotchgard Technology technology enhancements
...
- Annual review and certification with Atlas Roofing technical representatives
...
- Atlas Roofing Pinnacle® Pristine detailed specifications and performance data
- Scotchgard Technology installation diagrams and technical illustrations
- HVHZ 6-nail pattern layouts and fastener specifications
- Wind load calculations and resistance performance charts
- Material storage and handling requirements for Pinnacle® Pristine
...
- NOA Various Compliance Verification Checklist
- Scotchgard Technology Installation Quality Control Form
...
- Atlas Roofing technical support emergency contact information
...
*This SOP ensures proper installation of Atlas Roofing Pinnacle® Pristine roofing systems in High Velocity Hurricane Zone areas, maintaining full compliance with NOA Various requirements and supporting Florida First Roofing LLC's commitment to superior wind-resistant roofing installations.*