# FFR SOP-EAG-CAP-HVHZ: Eagle Roofing Tile Capistrano Concrete Roof Tiles HVHZ Installation Procedures
...
**NOA Information:**
- **NOA Number:** 22-0718.01
- **Expiration Date:** 2027-07-18
- **Wind Rating:** 150 mph with proper installation
- **Product:** Capistrano Concrete Roof Tiles

**Metadata Tags:** #MIAMI_DADE_NOA #HVHZ_INSTALLATION #EAGLE_ROOFING_TILE #CAPISTRANO_CONCRETE_ROOF_TILES #WIND_RESISTANCE #FLORIDA_BUILDING_CODE

---

## BLOCK 1: PURPOSE - Strategic Intent and Business Objectives

To establish comprehensive installation procedures for Eagle Roofing Tile Capistrano Concrete Roof Tiles roofing systems in High Velocity Hurricane Zone (HVHZ) areas, ensuring full compliance with Miami-Dade County Notice of Acceptance (NOA) requirements and Florida Building Code standards for wind resistance up to 150 mph with proper installation.

**Strategic Objectives:**
- Ensure 100% compliance with NOA 22-0718.01 requirements
- Achieve maximum wind resistance performance of 150 mph with proper installation
...
- Full integration of manufacturer-specific technologies (Hurricane-Resistant Tile System)
...
This SOP applies to:
- All installations of Eagle Roofing Tile Capistrano Concrete Roof Tiles in HVHZ areas
...
- Design Wind Speed: Up to 150 mph with proper installation
...
**Notice of Acceptance (NOA):** Miami-Dade County approval certifying that Capistrano Concrete Roof Tiles has passed stringent testing and is approved for HVHZ installations per NOA 22-0718.01.
...
**Hurricane-Resistant Tile System:** Concrete tile system engineered specifically for hurricane-force wind resistance and structural load distribution.

**HVHZ Installation Pattern:** Enhanced 6-nail installation pattern required for wind speeds up to 150 mph with proper installation, exceeding standard 4-nail residential requirements.
...
- Ensure crew certification for Eagle Roofing Tile Capistrano Concrete Roof Tiles installation
...
### Lead Installer:
- Execute Hurricane-Resistant Tile System installation procedures
...
### Installation Crew:
- Follow manufacturer-specific installation guidelines for Capistrano Concrete Roof Tiles
- Implement proper Hurricane-Resistant Tile System procedures
...
- Verify compliance with NOA 22-0718.01 requirements
- Inspect Hurricane-Resistant Tile System implementation
...
1. Verify NOA 22-0718.01 is current and valid through 2027-07-18
2. Confirm Eagle Roofing Tile Capistrano Concrete Roof Tiles shipment matches NOA specifications
...
1. Verify Capistrano Concrete Roof Tiles bundles display Miami-Dade approval labeling
2. Check manufacturer date codes and storage condition requirements
3. Confirm fastener specifications: 11-gauge steel roofing nails, minimum 1.25" long
4. Set up Hurricane-Resistant Tile System installation tools and guides
5. Prepare HVHZ-specific installation equipment and nail guns

### 5.2 Hurricane-Resistant Tile System Installation Procedures

**5.2.1 Starter Course Installation:**
1. Install manufacturer-approved starter strip at eave edge
2. Apply Hurricane-Resistant Tile System alignment procedures
3. Begin first course with proper overhang (typically 1/4" to 3/8")
4. Implement 6-nail pattern from start
5. Verify initial course alignment with Hurricane-Resistant Tile System guides

**5.2.2 Field Shingle Installation with HVHZ Pattern:**
1. Install tiles with 2 fasteners per tile minimum per HVHZ requirements
2. Maintain 3" minimum headlap throughout installation
...
2. Apply Hurricane-Resistant Tile System to ridge installation
...
1. Inspect Hurricane-Resistant Tile System implementation throughout roof
...
1. Complete NOA 22-0718.01 compliance checklist
2. Document Hurricane-Resistant Tile System implementation
...
- **FORM-NOA-EAG-CAP-HVHZ-01:** NOA Verification and Material Certification
- **FORM-NOA-EAG-CAP-HVHZ-02:** Hurricane-Resistant Tile System Installation Checklist
- **FORM-NOA-EAG-CAP-HVHZ-03:** HVHZ 6-Nail Pattern Verification Log
- **FORM-NOA-EAG-CAP-HVHZ-04:** Wind Resistance Testing and Quality Control Report
- **FORM-NOA-EAG-CAP-HVHZ-05:** Miami-Dade Building Official Inspection Readiness

### Manufacturer-Specific Records
- Complete NOA 22-0718.01 documentation maintained on-site
- Eagle Roofing Tile installation instructions and technical bulletins
- Material certificates with Miami-Dade approval labeling verification
- Hurricane-Resistant Tile System implementation photos and documentation
...
- 100% compliance with NOA 22-0718.01 installation requirements
- Zero tolerance for non-NOA approved materials or fasteners
- Complete Hurricane-Resistant Tile System implementation verification
- Full documentation of 6-nail HVHZ pattern compliance
- Wind resistance performance verification up to 150 mph with proper installation

### Installation Quality Metrics
- Fastener placement accuracy: 100% within manufacturer-specified zones
- Hurricane-Resistant Tile System compliance: 100% proper implementation
...
- Hurricane-Resistant Tile System functionality verification throughout installation
...
- Proper handling of Hurricane-Resistant Tile System components and tools
- Heat stress prevention during extended Eagle Roofing Tile installation procedures
- Tool safety for specialized Hurricane-Resistant Tile System equipment
...
- Humidity considerations for Hurricane-Resistant Tile System performance
- Emergency procedure implementation for severe weather events

### Material Handling Safety
- Proper lifting techniques for Capistrano Concrete Roof Tiles bundles and materials
...
- Ergonomic considerations for extended Hurricane-Resistant Tile System installation work

---

## BLOCK 9: TRAINING REQUIREMENTS - Competency Development and Certification

### Eagle Roofing Tile Certification Requirements
- Eagle Roofing Tile Capistrano Concrete Roof Tiles installation certification (required)
- Hurricane-Resistant Tile System specialized training completion
...
- Hurricane-Resistant Tile System safety procedures
...
- NOA 22-0718.01 full compliance with all specifications
...
- Expiration date monitoring and renewal procedures (current through 2027-07-18)
...
- Hurricane-Resistant Tile System implementation success: 100% proper execution
...
- Eagle Roofing Tile certification maintenance: 100% crew certification compliance
...
- Miami-Dade County NOA 22-0718.01 - Eagle Roofing Tile Capistrano Concrete Roof Tiles
...
- Eagle Roofing Tile Capistrano Concrete Roof Tiles Installation Instructions
- Hurricane-Resistant Tile System Technical Guide and Specifications
- Eagle Roofing Tile Wind Resistance Performance Data and Testing Results
- Eagle Roofing Tile Warranty Requirements and Registration Procedures
- Eagle Roofing Tile Technical Bulletins and Installation Updates
...
- Initial Eagle Roofing Tile Capistrano Concrete Roof Tiles HVHZ installation SOP
- Integration of NOA 22-0718.01 requirements and specifications
- Implementation of Hurricane-Resistant Tile System procedures
...
- Q3 2025: Hurricane-Resistant Tile System technology enhancements
...
- Annual review and certification with Eagle Roofing Tile technical representatives
...
- Eagle Roofing Tile Capistrano Concrete Roof Tiles detailed specifications and performance data
- Hurricane-Resistant Tile System installation diagrams and technical illustrations
- HVHZ 6-nail pattern layouts and fastener specifications
- Wind load calculations and resistance performance charts
- Material storage and handling requirements for Capistrano Concrete Roof Tiles
...
- NOA 22-0718.01 Compliance Verification Checklist
- Hurricane-Resistant Tile System Installation Quality Control Form
...
- Eagle Roofing Tile technical support emergency contact information
...
*This SOP ensures proper installation of Eagle Roofing Tile Capistrano Concrete Roof Tiles roofing systems in High Velocity Hurricane Zone areas, maintaining full compliance with NOA 22-0718.01 requirements and supporting Florida First Roofing LLC's commitment to superior wind-resistant roofing installations.*