# FFR SOP-8214: DUVAL COUNTY OPERATIONS
...
This SOP applies to all Florida First Roofing LLC operations within Duval County boundaries, including:

**Geographic Coverage:**
- Jacksonville (County Seat) and all incorporated municipalities
- Unincorporated areas under Duval County jurisdiction
- All residential, commercial, and industrial properties within county limits
- Emergency response operations throughout Duval County
...
**Personnel Coverage:**
- All field crews operating in Duval County
- Project managers and supervisors
- Customer service representatives
- Administrative staff handling Duval County operations

---

## BLOCK 3: DEFINITIONS - Key Terms and Concepts

**Duval County Operations:** All Florida First Roofing business activities conducted within Duval County boundaries, including sales, installation, repair, maintenance, and customer service operations.

**Local Building Authority:** Duval County Building Department and any municipal building departments within incorporated areas.

**Hurricane Zone Classification:** Category 2 (105-129 mph) - NO - Standard Hurricane Zone

**Metropolitan/Port Environment:** Operational considerations specific to metropolitan/port characteristics of Duval County.

**County Permit Process:** Specific permit application, review, and inspection procedures required by Duval County and local municipalities.
...
- Overall Duval County operations oversight and strategic direction
...
- Day-to-day management of Duval County operations
- Local permit coordination and building official relationships
- Project scheduling and resource allocation
- Customer service and quality assurance

### Field Crews:
- Professional service delivery throughout Duval County
...
1. Review Duval County building code requirements
...
1. Complete Duval County building permit application
...
1. Coordinate with Duval County inspection schedule
...
1. Follow Duval County approved installation methods
...
2. Schedule required Duval County inspections
...
1. Schedule final Duval County building inspection
...
### Duval County Specific Forms:
- **FORM-8214-01:** Duval County Permit Application Checklist
- **FORM-8214-02:** Local Building Code Compliance Verification
- **FORM-8214-03:** Wind Load Calculation and Material Specification
- **FORM-8214-04:** Duval County Inspection Coordination Log
- **FORM-8214-05:** Customer Communication and Service Record

### Required Documentation:
- Valid Florida roofing contractor license
- Duval County business registration
...
- 100% compliance with Duval County building codes
...
### Duval County Specific Safety Requirements:
...
- Immediate notification of Duval County emergency services
...
### Required Training for Duval County Operations:
...
- Duval County market share and growth rate
...
- Initial comprehensive Duval County operations procedures
...
- **Duval County Building Department:** [To be updated with current contact]
- **Jacksonville Municipal Building Department:** [To be updated with current contact]
- **Duval County Emergency Management:** [To be updated with current contact]
...
**DISTRIBUTION:** DUVAL COUNTY OPERATIONS TEAM AND AUTHORIZED PERSONNEL
**NEXT REVIEW DATE:** January 18, 2026

---

*This SOP ensures effective and compliant roofing operations throughout Duval County and supports Florida First Roofing LLC's commitment to excellence in the Northeast Florida market.*