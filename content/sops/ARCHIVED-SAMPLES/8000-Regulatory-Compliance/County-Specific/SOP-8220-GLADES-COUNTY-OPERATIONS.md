# FFR SOP-8220: GLADES COUNTY OPERATIONS
...
**Metadata Tags:** #GLADES_COUNTY #AGRICULTURAL_SUGAR #SOUTH_CENTRAL #COUNTY_OPERATIONS #FLORIDA_ROOFING

---

## BLOCK 1: PURPOSE - Strategic Intent and Business Objectives

To establish comprehensive operational procedures for Florida First Roofing LLC operations within Glades County, ensuring full compliance with local building codes, permit requirements, environmental regulations, and emergency protocols while delivering superior roofing services throughout the Moore Haven area and all Glades County municipalities.

**Strategic Business Objectives:**
- Ensure 100% compliance with Glades County building codes and permit requirements
- Establish efficient operational workflows for agricultural/sugar environment operations
- Maintain superior customer service standards throughout Glades County service area
- Develop strong relationships with local building officials, inspectors, and municipal authorities
- Position Florida First Roofing as the premier roofing contractor in Glades County
...
This SOP applies to all Florida First Roofing LLC operations within Glades County boundaries, including:

**Geographic Coverage:**
- Moore Haven (County Seat) and all incorporated municipalities
- Unincorporated areas under Glades County jurisdiction
- All residential, commercial, and industrial properties within county limits
- Emergency response operations throughout Glades County
...
**Personnel Coverage:**
- All field crews operating in Glades County
- Project managers and supervisors
- Customer service representatives
- Administrative staff handling Glades County operations

---

## BLOCK 3: DEFINITIONS - Key Terms and Concepts

**Glades County Operations:** All Florida First Roofing business activities conducted within Glades County boundaries, including sales, installation, repair, maintenance, and customer service operations.

**Local Building Authority:** Glades County Building Department and any municipal building departments within incorporated areas.

**Hurricane Zone Classification:** Category 1 (85-104 mph) - NO - Standard Hurricane Zone

**Agricultural/Sugar Environment:** Operational considerations specific to agricultural/sugar characteristics of Glades County.

**County Permit Process:** Specific permit application, review, and inspection procedures required by Glades County and local municipalities.
...
- Overall Glades County operations oversight and strategic direction
...
- Day-to-day management of Glades County operations
- Local permit coordination and building official relationships
- Project scheduling and resource allocation
- Customer service and quality assurance

### Field Crews:
- Professional service delivery throughout Glades County
...
1. Review Glades County building code requirements
...
1. Complete Glades County building permit application
...
1. Coordinate with Glades County inspection schedule
...
1. Follow Glades County approved installation methods
...
2. Schedule required Glades County inspections
...
1. Schedule final Glades County building inspection
...
### Glades County Specific Forms:
- **FORM-8220-01:** Glades County Permit Application Checklist
- **FORM-8220-02:** Local Building Code Compliance Verification
- **FORM-8220-03:** Wind Load Calculation and Material Specification
- **FORM-8220-04:** Glades County Inspection Coordination Log
- **FORM-8220-05:** Customer Communication and Service Record

### Required Documentation:
- Valid Florida roofing contractor license
- Glades County business registration
...
- 100% compliance with Glades County building codes
...
### Required Training for Glades County Operations:
- Local building code and permit process training (8 hours)
- Agricultural/Sugar environment safety and operational procedures (4 hours)
...
- Glades County market share and growth rate
...
- Initial comprehensive Glades County operations procedures
- Integration with Florida First Roofing operational systems
- Agricultural/Sugar environment specific protocol development
...
- **Glades County Building Department:** [To be updated with current contact]
- **Moore Haven Municipal Building Department:** [To be updated with current contact]
- **Glades County Emergency Management:** [To be updated with current contact]
...
- **Primary Industries:** Agricultural/Sugar
...
**DISTRIBUTION:** GLADES COUNTY OPERATIONS TEAM AND AUTHORIZED PERSONNEL
**NEXT REVIEW DATE:** January 18, 2026

---

*This SOP ensures effective and compliant roofing operations throughout Glades County and supports Florida First Roofing LLC's commitment to excellence in the South Central Florida market.*