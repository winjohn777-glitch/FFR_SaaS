# FFR SOP-CER-LAN-HVHZ: CertainTeed Landmark PRO® HVHZ Installation Procedures
...
**Metadata Tags:** #MIAMI_DADE_NOA #HVHZ_INSTALLATION #CERTAINTEED #LANDMARK_PRO_ #WIND_RESISTANCE #FLORIDA_BUILDING_CODE

---

## BLOCK 1: PURPOSE - Strategic Intent and Business Objectives

To establish comprehensive installation procedures for CertainTeed Landmark PRO® roofing systems in High Velocity Hurricane Zone (HVHZ) areas, ensuring full compliance with Miami-Dade County Notice of Acceptance (NOA) requirements and Florida Building Code standards for wind resistance up to 130 mph with proper installation.

**Strategic Objectives:**
- Ensure 100% compliance with NOA 22-1109.02 requirements
- Achieve maximum wind resistance performance of 130 mph with proper installation
...
This SOP applies to:
- All installations of CertainTeed Landmark PRO® in HVHZ areas
...
- Design Wind Speed: Up to 130 mph with proper installation
...
**Notice of Acceptance (NOA):** Miami-Dade County approval certifying that Landmark PRO® has passed stringent testing and is approved for HVHZ installations per NOA 22-1109.02.
...
**HVHZ Installation Pattern:** Enhanced 6-nail installation pattern required for wind speeds up to 130 mph with proper installation, exceeding standard 4-nail residential requirements.
...
- Ensure crew certification for CertainTeed Landmark PRO® installation
...
### Installation Crew:
- Follow manufacturer-specific installation guidelines for Landmark PRO®
...
2. Confirm CertainTeed Landmark PRO® shipment matches NOA specifications
...
1. Verify Landmark PRO® bundles display Miami-Dade approval labeling
...
- Wind resistance performance verification up to 130 mph with proper installation
...
- Proper lifting techniques for Landmark PRO® bundles and materials
...
- CertainTeed Landmark PRO® installation certification (required)
...
- Miami-Dade County NOA 22-1109.02 - CertainTeed Landmark PRO®
...
- CertainTeed Landmark PRO® Installation Instructions
...
- Initial CertainTeed Landmark PRO® HVHZ installation SOP
...
- CertainTeed Landmark PRO® detailed specifications and performance data
...
- Material storage and handling requirements for Landmark PRO®
...
*This SOP ensures proper installation of CertainTeed Landmark PRO® roofing systems in High Velocity Hurricane Zone areas, maintaining full compliance with NOA 22-1109.02 requirements and supporting Florida First Roofing LLC's commitment to superior wind-resistant roofing installations.*