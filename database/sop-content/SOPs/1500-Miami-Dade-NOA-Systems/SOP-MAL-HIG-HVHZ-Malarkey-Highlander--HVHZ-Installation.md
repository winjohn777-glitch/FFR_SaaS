# FFR SOP-MAL-HIG-HVHZ: Malarkey Highlander® HVHZ Installation Procedures
...
**Metadata Tags:** #MIAMI_DADE_NOA #HVHZ_INSTALLATION #MALARKEY #HIGHLANDER_ #WIND_RESISTANCE #FLORIDA_BUILDING_CODE

---

## BLOCK 1: PURPOSE - Strategic Intent and Business Objectives

To establish comprehensive installation procedures for Malarkey Highlander® roofing systems in High Velocity Hurricane Zone (HVHZ) areas, ensuring full compliance with Miami-Dade County Notice of Acceptance (NOA) requirements and Florida Building Code standards for wind resistance up to 110-130 mph.

**Strategic Objectives:**
- Ensure 100% compliance with NOA Various requirements
- Achieve maximum wind resistance performance of 110-130 mph
...
- Full integration of manufacturer-specific technologies (NEX Polymer Technology)
...
This SOP applies to:
- All installations of Malarkey Highlander® in HVHZ areas
...
- Design Wind Speed: Up to 110-130 mph
...
**Notice of Acceptance (NOA):** Miami-Dade County approval certifying that Highlander® has passed stringent testing and is approved for HVHZ installations per NOA Various.
...
**NEX Polymer Technology:** Revolutionary polymer-modified shingle technology that enhances flexibility and impact resistance.

**HVHZ Installation Pattern:** Enhanced 6-nail installation pattern required for wind speeds up to 110-130 mph, exceeding standard 4-nail residential requirements.
...
- Ensure crew certification for Malarkey Highlander® installation
...
### Lead Installer:
- Execute NEX Polymer Technology installation procedures
...
### Installation Crew:
- Follow manufacturer-specific installation guidelines for Highlander®
- Implement proper NEX Polymer Technology procedures
...
- Inspect NEX Polymer Technology implementation
...
2. Confirm Malarkey Highlander® shipment matches NOA specifications
...
1. Verify Highlander® bundles display Miami-Dade approval labeling
...
2. Apply NEX Polymer Technology to ridge installation
...
1. Inspect NEX Polymer Technology implementation throughout roof
...
2. Document NEX Polymer Technology implementation
...
- **FORM-NOA-MAL-HIG-HVHZ-01:** NOA Verification and Material Certification
- **FORM-NOA-MAL-HIG-HVHZ-02:** NEX Polymer Technology Installation Checklist
- **FORM-NOA-MAL-HIG-HVHZ-03:** HVHZ 6-Nail Pattern Verification Log
- **FORM-NOA-MAL-HIG-HVHZ-04:** Wind Resistance Testing and Quality Control Report
- **FORM-NOA-MAL-HIG-HVHZ-05:** Miami-Dade Building Official Inspection Readiness

### Manufacturer-Specific Records
- Complete NOA Various documentation maintained on-site
- Malarkey installation instructions and technical bulletins
- Material certificates with Miami-Dade approval labeling verification
- NEX Polymer Technology implementation photos and documentation
...
- Complete NEX Polymer Technology implementation verification
- Full documentation of 6-nail HVHZ pattern compliance
- Wind resistance performance verification up to 110-130 mph

### Installation Quality Metrics
- Fastener placement accuracy: 100% within manufacturer-specified zones
- NEX Polymer Technology compliance: 100% proper implementation
...
- NEX Polymer Technology functionality verification throughout installation
...
- Proper handling of NEX Polymer Technology components and tools
- Heat stress prevention during extended Malarkey installation procedures
- Tool safety for specialized NEX Polymer Technology equipment
...
- Humidity considerations for NEX Polymer Technology performance
- Emergency procedure implementation for severe weather events

### Material Handling Safety
- Proper lifting techniques for Highlander® bundles and materials
...
- Ergonomic considerations for extended NEX Polymer Technology installation work

---

## BLOCK 9: TRAINING REQUIREMENTS - Competency Development and Certification

### Malarkey Certification Requirements
- Malarkey Highlander® installation certification (required)
- NEX Polymer Technology specialized training completion
...
- NEX Polymer Technology safety procedures
...
- NEX Polymer Technology implementation success: 100% proper execution
...
- Malarkey certification maintenance: 100% crew certification compliance
...
- Miami-Dade County NOA Various - Malarkey Highlander®
...
- Malarkey Highlander® Installation Instructions
- NEX Polymer Technology Technical Guide and Specifications
- Malarkey Wind Resistance Performance Data and Testing Results
- Malarkey Warranty Requirements and Registration Procedures
- Malarkey Technical Bulletins and Installation Updates
...
- Initial Malarkey Highlander® HVHZ installation SOP
- Integration of NOA Various requirements and specifications
- Implementation of NEX Polymer Technology procedures
...
- Q3 2025: NEX Polymer Technology technology enhancements
...
- Annual review and certification with Malarkey technical representatives
...
- Malarkey Highlander® detailed specifications and performance data
- NEX Polymer Technology installation diagrams and technical illustrations
- HVHZ 6-nail pattern layouts and fastener specifications
- Wind load calculations and resistance performance charts
- Material storage and handling requirements for Highlander®
...
- NEX Polymer Technology Installation Quality Control Form
...
- Malarkey technical support emergency contact information
...
*This SOP ensures proper installation of Malarkey Highlander® roofing systems in High Velocity Hurricane Zone areas, maintaining full compliance with NOA Various requirements and supporting Florida First Roofing LLC's commitment to superior wind-resistant roofing installations.*