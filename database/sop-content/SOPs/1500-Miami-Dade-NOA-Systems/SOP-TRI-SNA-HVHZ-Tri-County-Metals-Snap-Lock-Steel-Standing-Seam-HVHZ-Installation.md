# FFR SOP-TRI-SNA-HVHZ: Tri County Metals Snap-Lock Steel Standing Seam HVHZ Installation Procedures
...
**NOA Information:**
- **NOA Number:** 22-1201.03
- **Expiration Date:** 2027-12-01
- **Wind Rating:** 160 mph (Vasd) / 200 mph (Vult)
- **Product:** Snap-Lock Steel Standing Seam

**Metadata Tags:** #MIAMI_DADE_NOA #HVHZ_INSTALLATION #TRI_COUNTY_METALS #SNAP_LOCK_STEEL_STANDING_SEAM #WIND_RESISTANCE #FLORIDA_BUILDING_CODE

---

## BLOCK 1: PURPOSE - Strategic Intent and Business Objectives

To establish comprehensive installation procedures for Tri County Metals Snap-Lock Steel Standing Seam roofing systems in High Velocity Hurricane Zone (HVHZ) areas, ensuring full compliance with Miami-Dade County Notice of Acceptance (NOA) requirements and Florida Building Code standards for wind resistance up to 160 mph (Vasd) / 200 mph (Vult).

**Strategic Objectives:**
- Ensure 100% compliance with NOA 22-1201.03 requirements
- Achieve maximum wind resistance performance of 160 mph (Vasd) / 200 mph (Vult)
...
- Full integration of manufacturer-specific technologies (Snap-Lock Mechanical Seaming)
...
This SOP applies to:
- All installations of Tri County Metals Snap-Lock Steel Standing Seam in HVHZ areas
...
- Design Wind Speed: Up to 160 mph (Vasd) / 200 mph (Vult)
...
**Notice of Acceptance (NOA):** Miami-Dade County approval certifying that Snap-Lock Steel Standing Seam has passed stringent testing and is approved for HVHZ installations per NOA 22-1201.03.
...
**Snap-Lock Mechanical Seaming:** Mechanical snap-lock seaming system providing weathertight panel connections with thermal expansion capability.

**HVHZ Installation Pattern:** Enhanced 6-nail installation pattern required for wind speeds up to 160 mph (Vasd) / 200 mph (Vult), exceeding standard 4-nail residential requirements.
...
**Solid Wood Deck Requirement:** Minimum Solid structural deck sheathing required for proper fastener engagement and wind uplift resistance.
...
- Ensure crew certification for Tri County Metals Snap-Lock Steel Standing Seam installation
...
### Lead Installer:
- Execute Snap-Lock Mechanical Seaming installation procedures
...
### Installation Crew:
- Follow manufacturer-specific installation guidelines for Snap-Lock Steel Standing Seam
- Implement proper Snap-Lock Mechanical Seaming procedures
...
- Verify compliance with NOA 22-1201.03 requirements
- Inspect Snap-Lock Mechanical Seaming implementation
...
1. Verify NOA 22-1201.03 is current and valid through 2027-12-01
2. Confirm Tri County Metals Snap-Lock Steel Standing Seam shipment matches NOA specifications
...
1. Inspect deck for Solid structural deck
...
1. Verify Snap-Lock Steel Standing Seam bundles display Miami-Dade approval labeling
...
4. Set up Snap-Lock Mechanical Seaming installation tools and guides
5. Prepare HVHZ-specific installation equipment and nail guns

### 5.2 Snap-Lock Mechanical Seaming Installation Procedures

**5.2.1 Starter Course Installation:**
1. Install manufacturer-approved starter strip at eave edge
2. Apply Snap-Lock Mechanical Seaming alignment procedures
3. Begin first course with proper overhang (typically 1/4" to 3/8")
4. Implement 6-nail pattern from start
5. Verify initial course alignment with Snap-Lock Mechanical Seaming guides

**5.2.2 Field Shingle Installation with HVHZ Pattern:**
1. Install structural clips at 16" maximum on centers spacing per HVHZ requirements
2. Position 12" or 16" coverage options panels with proper thermal expansion allowance
3. Engage mechanical seaming system per manufacturer specifications
4. Verify 1.25" snap-lock profile seam height for proper weather sealing
...
2. Apply Snap-Lock Mechanical Seaming to ridge installation
...
1. Inspect Snap-Lock Mechanical Seaming implementation throughout roof
...
1. Complete NOA 22-1201.03 compliance checklist
2. Document Snap-Lock Mechanical Seaming implementation
...
- **FORM-NOA-TRI-SNA-HVHZ-01:** NOA Verification and Material Certification
- **FORM-NOA-TRI-SNA-HVHZ-02:** Snap-Lock Mechanical Seaming Installation Checklist
- **FORM-NOA-TRI-SNA-HVHZ-03:** HVHZ 6-Nail Pattern Verification Log
- **FORM-NOA-TRI-SNA-HVHZ-04:** Wind Resistance Testing and Quality Control Report
- **FORM-NOA-TRI-SNA-HVHZ-05:** Miami-Dade Building Official Inspection Readiness

### Manufacturer-Specific Records
- Complete NOA 22-1201.03 documentation maintained on-site
- Tri County Metals installation instructions and technical bulletins
- Material certificates with Miami-Dade approval labeling verification
- Snap-Lock Mechanical Seaming implementation photos and documentation
...
- 100% compliance with NOA 22-1201.03 installation requirements
- Zero tolerance for non-NOA approved materials or fasteners
- Complete Snap-Lock Mechanical Seaming implementation verification
- Full documentation of 6-nail HVHZ pattern compliance
- Wind resistance performance verification up to 160 mph (Vasd) / 200 mph (Vult)

### Installation Quality Metrics
- Fastener placement accuracy: 100% within manufacturer-specified zones
- Snap-Lock Mechanical Seaming compliance: 100% proper implementation
...
- Snap-Lock Mechanical Seaming functionality verification throughout installation
...
- Proper handling of Snap-Lock Mechanical Seaming components and tools
- Heat stress prevention during extended Tri County Metals installation procedures
- Tool safety for specialized Snap-Lock Mechanical Seaming equipment
...
- Humidity considerations for Snap-Lock Mechanical Seaming performance
- Emergency procedure implementation for severe weather events

### Material Handling Safety
- Proper lifting techniques for Snap-Lock Steel Standing Seam bundles and materials
...
- Ergonomic considerations for extended Snap-Lock Mechanical Seaming installation work

---

## BLOCK 9: TRAINING REQUIREMENTS - Competency Development and Certification

### Tri County Metals Certification Requirements
- Tri County Metals Snap-Lock Steel Standing Seam installation certification (required)
- Snap-Lock Mechanical Seaming specialized training completion
...
- Snap-Lock Mechanical Seaming safety procedures
...
- NOA 22-1201.03 full compliance with all specifications
...
- Expiration date monitoring and renewal procedures (current through 2027-12-01)
...
- Snap-Lock Mechanical Seaming implementation success: 100% proper execution
...
- Tri County Metals certification maintenance: 100% crew certification compliance
...
- Miami-Dade County NOA 22-1201.03 - Tri County Metals Snap-Lock Steel Standing Seam
...
- Tri County Metals Snap-Lock Steel Standing Seam Installation Instructions
- Snap-Lock Mechanical Seaming Technical Guide and Specifications
- Tri County Metals Wind Resistance Performance Data and Testing Results
- Tri County Metals Warranty Requirements and Registration Procedures
- Tri County Metals Technical Bulletins and Installation Updates
...
- Initial Tri County Metals Snap-Lock Steel Standing Seam HVHZ installation SOP
- Integration of NOA 22-1201.03 requirements and specifications
- Implementation of Snap-Lock Mechanical Seaming procedures
...
- Q3 2025: Snap-Lock Mechanical Seaming technology enhancements
...
- Annual review and certification with Tri County Metals technical representatives
...
- Tri County Metals Snap-Lock Steel Standing Seam detailed specifications and performance data
- Snap-Lock Mechanical Seaming installation diagrams and technical illustrations
- HVHZ 6-nail pattern layouts and fastener specifications
- Wind load calculations and resistance performance charts
- Material storage and handling requirements for Snap-Lock Steel Standing Seam
...
- NOA 22-1201.03 Compliance Verification Checklist
- Snap-Lock Mechanical Seaming Installation Quality Control Form
...
- Tri County Metals technical support emergency contact information
...
*This SOP ensures proper installation of Tri County Metals Snap-Lock Steel Standing Seam roofing systems in High Velocity Hurricane Zone areas, maintaining full compliance with NOA 22-1201.03 requirements and supporting Florida First Roofing LLC's commitment to superior wind-resistant roofing installations.*