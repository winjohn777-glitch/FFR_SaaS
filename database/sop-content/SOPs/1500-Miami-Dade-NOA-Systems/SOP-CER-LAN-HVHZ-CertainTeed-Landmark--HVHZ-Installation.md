# FFR SOP-CER-LAN-HVHZ: CertainTeed Landmark® HVHZ Installation Procedures
...
**NOA Information:**
- **NOA Number:** 22-1109.02
- **Expiration Date:** 2028-01-02
- **Wind Rating:** 110 mph standard / 130 mph with upgrades
- **Product:** Landmark®

**Metadata Tags:** #MIAMI_DADE_NOA #HVHZ_INSTALLATION #CERTAINTEED #LANDMARK_ #WIND_RESISTANCE #FLORIDA_BUILDING_CODE

---

## BLOCK 1: PURPOSE - Strategic Intent and Business Objectives

To establish comprehensive installation procedures for CertainTeed Landmark® roofing systems in High Velocity Hurricane Zone (HVHZ) areas, ensuring full compliance with Miami-Dade County Notice of Acceptance (NOA) requirements and Florida Building Code standards for wind resistance up to 110 mph standard / 130 mph with upgrades.

**Strategic Objectives:**
- Ensure 100% compliance with NOA 22-1109.02 requirements
- Achieve maximum wind resistance performance of 110 mph standard / 130 mph with upgrades
...
- Full integration of manufacturer-specific technologies (NailTrak Technology)
...
This SOP applies to:
- All installations of CertainTeed Landmark® in HVHZ areas
...
- Design Wind Speed: Up to 110 mph standard / 130 mph with upgrades
...
**Notice of Acceptance (NOA):** Miami-Dade County approval certifying that Landmark® has passed stringent testing and is approved for HVHZ installations per NOA 22-1109.02.
...
**NailTrak Technology:** Precision nailing zone guidance system with defined lines for optimal fastener placement and wind resistance.

**HVHZ Installation Pattern:** Enhanced 6-nail installation pattern required for wind speeds up to 110 mph standard / 130 mph with upgrades, exceeding standard 4-nail residential requirements.
...
**Solid Wood Deck Requirement:** Minimum Solid wood sheathing minimum thickness sheathing required for proper fastener engagement and wind uplift resistance.
...
- Ensure crew certification for CertainTeed Landmark® installation
...
### Lead Installer:
- Execute NailTrak Technology installation procedures
...
### Installation Crew:
- Follow manufacturer-specific installation guidelines for Landmark®
- Implement proper NailTrak Technology procedures
...
- Verify compliance with NOA 22-1109.02 requirements
- Inspect NailTrak Technology implementation
...
1. Verify NOA 22-1109.02 is current and valid through 2028-01-02
2. Confirm CertainTeed Landmark® shipment matches NOA specifications
...
1. Inspect deck for Solid wood sheathing minimum thickness
...
1. Verify Landmark® bundles display Miami-Dade approval labeling
...
2. Apply NailTrak Technology to ridge installation
...
1. Inspect NailTrak Technology implementation throughout roof
...
1. Complete NOA 22-1109.02 compliance checklist
2. Document NailTrak Technology implementation
...
- **FORM-NOA-CER-LAN-HVHZ-01:** NOA Verification and Material Certification
- **FORM-NOA-CER-LAN-HVHZ-02:** NailTrak Technology Installation Checklist
- **FORM-NOA-CER-LAN-HVHZ-03:** HVHZ 6-Nail Pattern Verification Log
- **FORM-NOA-CER-LAN-HVHZ-04:** Wind Resistance Testing and Quality Control Report
- **FORM-NOA-CER-LAN-HVHZ-05:** Miami-Dade Building Official Inspection Readiness

### Manufacturer-Specific Records
- Complete NOA 22-1109.02 documentation maintained on-site
- CertainTeed installation instructions and technical bulletins
- Material certificates with Miami-Dade approval labeling verification
- NailTrak Technology implementation photos and documentation
...
- 100% compliance with NOA 22-1109.02 installation requirements
- Zero tolerance for non-NOA approved materials or fasteners
- Complete NailTrak Technology implementation verification
- Full documentation of 6-nail HVHZ pattern compliance
- Wind resistance performance verification up to 110 mph standard / 130 mph with upgrades

### Installation Quality Metrics
- Fastener placement accuracy: 100% within manufacturer-specified zones
- NailTrak Technology compliance: 100% proper implementation
...
- NailTrak Technology functionality verification throughout installation
...
- Proper handling of NailTrak Technology components and tools
- Heat stress prevention during extended CertainTeed installation procedures
- Tool safety for specialized NailTrak Technology equipment
...
- Humidity considerations for NailTrak Technology performance
- Emergency procedure implementation for severe weather events

### Material Handling Safety
- Proper lifting techniques for Landmark® bundles and materials
...
- Ergonomic considerations for extended NailTrak Technology installation work

---

## BLOCK 9: TRAINING REQUIREMENTS - Competency Development and Certification

### CertainTeed Certification Requirements
- CertainTeed Landmark® installation certification (required)
- NailTrak Technology specialized training completion
...
- NailTrak Technology safety procedures
...
- NOA 22-1109.02 full compliance with all specifications
...
- Expiration date monitoring and renewal procedures (current through 2028-01-02)
...
- NailTrak Technology implementation success: 100% proper execution
...
- CertainTeed certification maintenance: 100% crew certification compliance
...
- Miami-Dade County NOA 22-1109.02 - CertainTeed Landmark®
...
- CertainTeed Landmark® Installation Instructions
- NailTrak Technology Technical Guide and Specifications
- CertainTeed Wind Resistance Performance Data and Testing Results
- CertainTeed Warranty Requirements and Registration Procedures
- CertainTeed Technical Bulletins and Installation Updates
...
- Initial CertainTeed Landmark® HVHZ installation SOP
- Integration of NOA 22-1109.02 requirements and specifications
- Implementation of NailTrak Technology procedures
...
- Q3 2025: NailTrak Technology technology enhancements
...
- Annual review and certification with CertainTeed technical representatives
...
- CertainTeed Landmark® detailed specifications and performance data
- NailTrak Technology installation diagrams and technical illustrations
- HVHZ 6-nail pattern layouts and fastener specifications
- Wind load calculations and resistance performance charts
- Material storage and handling requirements for Landmark®
...
- NOA 22-1109.02 Compliance Verification Checklist
- NailTrak Technology Installation Quality Control Form
...
- CertainTeed technical support emergency contact information
...
*This SOP ensures proper installation of CertainTeed Landmark® roofing systems in High Velocity Hurricane Zone areas, maintaining full compliance with NOA 22-1109.02 requirements and supporting Florida First Roofing LLC's commitment to superior wind-resistant roofing installations.*