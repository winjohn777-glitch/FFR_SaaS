# FFR SOP-CAR-SUR-HVHZ: Carlisle Sure-Weld TPO Membrane System HVHZ Installation Procedures
...
**NOA Information:**
- **NOA Number:** 21-0806.05
- **Expiration Date:** 2026-08-06
- **Wind Rating:** Per system design - up to 180 mph
- **Product:** Sure-Weld TPO Membrane System

**Metadata Tags:** #MIAMI_DADE_NOA #HVHZ_INSTALLATION #CARLISLE #SURE_WELD_TPO_MEMBRANE_SYSTEM #WIND_RESISTANCE #FLORIDA_BUILDING_CODE

---

## BLOCK 1: PURPOSE - Strategic Intent and Business Objectives

To establish comprehensive installation procedures for Carlisle Sure-Weld TPO Membrane System roofing systems in High Velocity Hurricane Zone (HVHZ) areas, ensuring full compliance with Miami-Dade County Notice of Acceptance (NOA) requirements and Florida Building Code standards for wind resistance up to Per system design - up to 180 mph.

**Strategic Objectives:**
- Ensure 100% compliance with NOA 21-0806.05 requirements
- Achieve maximum wind resistance performance of Per system design - up to 180 mph
...
- Full integration of manufacturer-specific technologies (Sure-Weld TPO Membrane System)
...
This SOP applies to:
- All installations of Carlisle Sure-Weld TPO Membrane System in HVHZ areas
...
- Design Wind Speed: Up to Per system design - up to 180 mph
...
**Notice of Acceptance (NOA):** Miami-Dade County approval certifying that Sure-Weld TPO Membrane System has passed stringent testing and is approved for HVHZ installations per NOA 21-0806.05.
...
**Sure-Weld TPO Membrane System:** Hot-air welded TPO membrane system with enhanced fastening patterns for HVHZ wind resistance.

**HVHZ Installation Pattern:** Enhanced 6-nail installation pattern required for wind speeds up to Per system design - up to 180 mph, exceeding standard 4-nail residential requirements.
...
**Solid Wood Deck Requirement:** Minimum Steel, concrete, or wood deck sheathing required for proper fastener engagement and wind uplift resistance.
...
- Ensure crew certification for Carlisle Sure-Weld TPO Membrane System installation
...
### Lead Installer:
- Execute Sure-Weld TPO Membrane System installation procedures
...
### Installation Crew:
- Follow manufacturer-specific installation guidelines for Sure-Weld TPO Membrane System
- Implement proper Sure-Weld TPO Membrane System procedures
...
- Verify compliance with NOA 21-0806.05 requirements
- Inspect Sure-Weld TPO Membrane System implementation
...
1. Verify NOA 21-0806.05 is current and valid through 2026-08-06
2. Confirm Carlisle Sure-Weld TPO Membrane System shipment matches NOA specifications
...
1. Inspect deck for Steel, concrete, or wood deck
...
1. Verify Sure-Weld TPO Membrane System bundles display Miami-Dade approval labeling
...
4. Set up Sure-Weld TPO Membrane System installation tools and guides
5. Prepare HVHZ-specific installation equipment and nail guns

### 5.2 Sure-Weld TPO Membrane System Installation Procedures

**5.2.1 Starter Course Installation:**
1. Install manufacturer-approved starter strip at eave edge
2. Apply Sure-Weld TPO Membrane System alignment procedures
3. Begin first course with proper overhang (typically 1/4" to 3/8")
4. Implement 6-nail pattern from start
5. Verify initial course alignment with Sure-Weld TPO Membrane System guides

**5.2.2 Field Shingle Installation with HVHZ Pattern:**
1. Roll out 45, 60, 80 mil options membrane allowing for thermal relaxation
2. Position membrane with proper overlap for Hot-air welded seams
3. Secure membrane with enhanced fastening pattern for Design specific up to 180 mph
...
2. Apply Sure-Weld TPO Membrane System to ridge installation
...
1. Inspect Sure-Weld TPO Membrane System implementation throughout roof
...
1. Complete NOA 21-0806.05 compliance checklist
2. Document Sure-Weld TPO Membrane System implementation
...
- **FORM-NOA-CAR-SUR-HVHZ-01:** NOA Verification and Material Certification
- **FORM-NOA-CAR-SUR-HVHZ-02:** Sure-Weld TPO Membrane System Installation Checklist
- **FORM-NOA-CAR-SUR-HVHZ-03:** HVHZ 6-Nail Pattern Verification Log
- **FORM-NOA-CAR-SUR-HVHZ-04:** Wind Resistance Testing and Quality Control Report
- **FORM-NOA-CAR-SUR-HVHZ-05:** Miami-Dade Building Official Inspection Readiness

### Manufacturer-Specific Records
- Complete NOA 21-0806.05 documentation maintained on-site
- Carlisle installation instructions and technical bulletins
- Material certificates with Miami-Dade approval labeling verification
- Sure-Weld TPO Membrane System implementation photos and documentation
...
- 100% compliance with NOA 21-0806.05 installation requirements
- Zero tolerance for non-NOA approved materials or fasteners
- Complete Sure-Weld TPO Membrane System implementation verification
- Full documentation of 6-nail HVHZ pattern compliance
- Wind resistance performance verification up to Per system design - up to 180 mph

### Installation Quality Metrics
- Fastener placement accuracy: 100% within manufacturer-specified zones
- Sure-Weld TPO Membrane System compliance: 100% proper implementation
...
- Sure-Weld TPO Membrane System functionality verification throughout installation
...
- Proper handling of Sure-Weld TPO Membrane System components and tools
- Heat stress prevention during extended Carlisle installation procedures
- Tool safety for specialized Sure-Weld TPO Membrane System equipment
...
- Humidity considerations for Sure-Weld TPO Membrane System performance
- Emergency procedure implementation for severe weather events

### Material Handling Safety
- Proper lifting techniques for Sure-Weld TPO Membrane System bundles and materials
...
- Ergonomic considerations for extended Sure-Weld TPO Membrane System installation work

---

## BLOCK 9: TRAINING REQUIREMENTS - Competency Development and Certification

### Carlisle Certification Requirements
- Carlisle Sure-Weld TPO Membrane System installation certification (required)
- Sure-Weld TPO Membrane System specialized training completion
...
- Sure-Weld TPO Membrane System safety procedures
...
- NOA 21-0806.05 full compliance with all specifications
...
- Expiration date monitoring and renewal procedures (current through 2026-08-06)
...
- Sure-Weld TPO Membrane System implementation success: 100% proper execution
...
- Carlisle certification maintenance: 100% crew certification compliance
...
- Miami-Dade County NOA 21-0806.05 - Carlisle Sure-Weld TPO Membrane System
...
- Carlisle Sure-Weld TPO Membrane System Installation Instructions
- Sure-Weld TPO Membrane System Technical Guide and Specifications
- Carlisle Wind Resistance Performance Data and Testing Results
- Carlisle Warranty Requirements and Registration Procedures
- Carlisle Technical Bulletins and Installation Updates
...
- Initial Carlisle Sure-Weld TPO Membrane System HVHZ installation SOP
- Integration of NOA 21-0806.05 requirements and specifications
- Implementation of Sure-Weld TPO Membrane System procedures
...
- Q3 2025: Sure-Weld TPO Membrane System technology enhancements
...
- Annual review and certification with Carlisle technical representatives
...
- Carlisle Sure-Weld TPO Membrane System detailed specifications and performance data
- Sure-Weld TPO Membrane System installation diagrams and technical illustrations
- HVHZ 6-nail pattern layouts and fastener specifications
- Wind load calculations and resistance performance charts
- Material storage and handling requirements for Sure-Weld TPO Membrane System
...
- NOA 21-0806.05 Compliance Verification Checklist
- Sure-Weld TPO Membrane System Installation Quality Control Form
...
- Carlisle technical support emergency contact information
...
*This SOP ensures proper installation of Carlisle Sure-Weld TPO Membrane System roofing systems in High Velocity Hurricane Zone areas, maintaining full compliance with NOA 21-0806.05 requirements and supporting Florida First Roofing LLC's commitment to superior wind-resistant roofing installations.*