# FFR SOP-GAF-FOR-HVHZ: GAF Fortitude® HVHZ Installation Procedures
...
**Metadata Tags:** #MIAMI_DADE_NOA #HVHZ_INSTALLATION #GAF #FORTITUDE_ #WIND_RESISTANCE #FLORIDA_BUILDING_CODE

---

## BLOCK 1: PURPOSE - Strategic Intent and Business Objectives

To establish comprehensive installation procedures for GAF Fortitude® roofing systems in High Velocity Hurricane Zone (HVHZ) areas, ensuring full compliance with Miami-Dade County Notice of Acceptance (NOA) requirements and Florida Building Code standards for wind resistance up to 150 mph (Vasd) / 194 mph (Vult).
...
This SOP applies to:
- All installations of GAF Fortitude® in HVHZ areas
...
**Notice of Acceptance (NOA):** Miami-Dade County approval certifying that Fortitude® has passed stringent testing and is approved for HVHZ installations per NOA 21-1209.01.
...
- Ensure crew certification for GAF Fortitude® installation
...
### Installation Crew:
- Follow manufacturer-specific installation guidelines for Fortitude®
...
2. Confirm GAF Fortitude® shipment matches NOA specifications
...
1. Verify Fortitude® bundles display Miami-Dade approval labeling
...
- **FORM-NOA-GAF-FOR-HVHZ-01:** NOA Verification and Material Certification
- **FORM-NOA-GAF-FOR-HVHZ-02:** LayerLock Technology Installation Checklist
- **FORM-NOA-GAF-FOR-HVHZ-03:** HVHZ 6-Nail Pattern Verification Log
- **FORM-NOA-GAF-FOR-HVHZ-04:** Wind Resistance Testing and Quality Control Report
- **FORM-NOA-GAF-FOR-HVHZ-05:** Miami-Dade Building Official Inspection Readiness
...
- Proper lifting techniques for Fortitude® bundles and materials
...
- GAF Fortitude® installation certification (required)
...
- Miami-Dade County NOA 21-1209.01 - GAF Fortitude®
...
- GAF Fortitude® Installation Instructions
...
- Initial GAF Fortitude® HVHZ installation SOP
...
- GAF Fortitude® detailed specifications and performance data
...
- Material storage and handling requirements for Fortitude®
...
*This SOP ensures proper installation of GAF Fortitude® roofing systems in High Velocity Hurricane Zone areas, maintaining full compliance with NOA 21-1209.01 requirements and supporting Florida First Roofing LLC's commitment to superior wind-resistant roofing installations.*